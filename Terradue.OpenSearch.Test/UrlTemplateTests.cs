...
namespace Terradue.OpenSearch.Test
{
    ...
    public class UrlTemplateTests
    {
        ...
        public void FQDNSearchParameters()
        {
            ...
            Assert.AreEqual(@"https://catalogue.nextgeoss.eu/opensearch/search.atom?collection_id=dataset&q=test&rows=20&page=&ext_bbox=-180,-90,180,90&identifier=&timerange_start=&timerange_end=&metadata_modified=&spatial_geom=&collection_id=SENTINEL2_L1C",
                result.ToString()
            );
        ...
        public void MixSearchParameters()
        {
            ...
            Assert.AreEqual(@"https://catalogue.nextgeoss.eu/opensearch/search.atom?collection_id=dataset&q=test&rows=20&page=&ext_bbox=-180,-90,180,90&identifier=&timerange_start=20190101&timerange_end=&metadata_modified=&spatial_geom=POINT(0%200)&collection_id=SENTINEL2_L1C",
                result.ToString()
            );
